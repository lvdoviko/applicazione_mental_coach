...
abstract class AppLocalizations {
  ...
  /// No description provided for @yourAgeLabel.
  ///
  /// In en, this message translates to:
  /// **'YOUR AGE'**
  ...
  /// No description provided for @traitCompetitive.
  ///
  /// In en, this message translates to:
  /// **'Competitive'**
  String get traitCompetitive;

  /// No description provided for @traitCompetitiveDesc.
  ///
  /// In en, this message translates to:
  /// **'You aim for victory and love challenges.'**
  String get traitCompetitiveDesc;
  ...
  /// No description provided for @traitReflective.
  ///
  /// In en, this message translates to:
  /// **'Reflective'**
  String get traitReflective;

  /// No description provided for @traitReflectiveDesc.
  ///
  /// In en, this message translates to:
  /// **'You analyze deeply and seek awareness.'**
  String get traitReflectiveDesc;

  /// No description provided for @traitEmpathetic.
  ///
  /// In en, this message translates to:
  /// **'Empathetic'**
  String get traitEmpathetic;

  /// No description provided for @traitEmpatheticDesc.
  ///
  /// In en, this message translates to:
  /// **'You listen to emotions and value support.'**
  String get traitEmpatheticDesc;

  /// No description provided for @traitEnergetic.
  ///
  /// In en, this message translates to:
  /// **'Energetic'**
  String get traitEnergetic;

  /// No description provided for @traitEnergeticDesc.
  ///
  /// In en, this message translates to:
  /// **'You are pure charge and motivation for others.'**
  String get traitEnergeticDesc;

  /// No description provided for @assigningCoach.
  ///
  /// In en, this message translates to:
  /// **'Assigning best coach for {userName}...'**
  String assigningCoach(String userName);

  /// No description provided for @coachResultTitle.
  ///
  /// In en, this message translates to:
  /// **'Your Perfect Match'**
  String get coachResultTitle;

  /// No description provided for @coachResultSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Based on your personality, we selected:'**
  String get coachResultSubtitle;
  ...
  /// No description provided for @avatarSelectionTitle.
  ///
  /// In en, this message translates to:
  /// **'Choose your Coach'**
  String get avatarSelectionTitle;

  /// No description provided for @avatarSelectionSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Who will accompany you on your journey?'**
  String get avatarSelectionSubtitle;

  /// No description provided for @coachAtlas.
  ///
  /// In en, this message translates to:
  /// **'Atlas'**
  String get coachAtlas;

  /// No description provided for @coachSerena.
  ///
  /// In en, this message translates to:
  /// **'Serena'**
  String get coachSerena;

  /// No description provided for @coachAtlasDesc.
  ///
  /// In en, this message translates to:
  /// **'Resilience, Focus, Strategy'**
  String get coachAtlasDesc;

  /// No description provided for @coachSerenaDesc.
  ///
  /// In en, this message translates to:
  /// **'Empathy, Calm, Intuition'**
  String get coachSerenaDesc;
  ...
  /// No description provided for @loadingConfiguring.
  ///
  /// In en, this message translates to:
  /// **'Configuring {coachName}...'**
  String loadingConfiguring(String coachName);

  /// No description provided for @loadingCalibrating.
  ///
  /// In en, this message translates to:
  /// **'Calibrating plan for {userName}...'**
